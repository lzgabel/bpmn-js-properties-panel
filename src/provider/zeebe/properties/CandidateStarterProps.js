...
function CandidateStarterGroups(props) {
  ...
  const getValue = () => {
    return process.get('zeebe:candidateStarterGroups') || '';
  };
  ...
  const setValue = (value) => {
    commandStack.execute('element.updateModdleProperties', {
      ...
      properties: {
        'zeebe:candidateStarterGroups': value
      }
    });
  };
...
function CandidateStarterUsers(props) {
  ...
  const getValue = () => {
    return process.get('zeebe:candidateStarterUsers') || '';
  };
  ...
  const setValue = (value) => {
    commandStack.execute('element.updateModdleProperties', {
      ...
      moddleElement: process,
      properties: {
        'zeebe:candidateStarterUsers': value
      }
    });
  };
